...
interface ProtectedRouteProps {
  allowedRoles?: string[];
  requireUserManagementAccess?: boolean;
  children?: ReactNode;
}

export const ProtectedRoute = ({ 
  allowedRoles = [], 
  requireUserManagementAccess = false,
  children 
}: ProtectedRouteProps) => {
  ...
  // Check if specific user management access is required
  if (requireUserManagementAccess && !canAccessUserManagementReports(user)) {
    console.log("ProtectedRoute: User lacks user management access");
