-- Drop both versions of get_dashboard_analytics function
DROP FUNCTION IF EXISTS public.get_dashboard_analytics(date, date, text);
DROP FUNCTION IF EXISTS public.get_dashboard_analytics(date, date, text, uuid);

-- Recreate the complete 4-parameter function with all logic
